        ...
        <div class="col-12">
            <div class="card mb-4">
                <div class="card-header pb-0">
                    <h5>Ajouter bon de commande </h5>
                </div>
                <div class="card-body px-0 pt-0 pb-2">
                    <div class="table-responsive p-0">
                        <form id="bon_de_commandes-form-id" method="post" enctype="multipart/form-data" action="{{ route('bon_de_commandes.store', $autoentrepreneur->id) }}" class="p-4">
                            @csrf
                        <table class="table">
                            <thead>
                                <tr>
                            ...
                            <tbody id="produit-table-body">
                                    ...
                                    <tr>
                                        ...
                                        <td class="align-middle text-center">
                                            <input type="number" class="form-control" value="{{ $numero_bon_de_commande }}"
                                                name="numero_bon_de_commande">
                                        </td>
                                        <td class=" align-middle text-center">
                                            <div class="d-flex flex-column justify-content-center">
                                                <h6 class="mb-0 text-sm">
                                                    <select name="fournisseur" id="fournisseurSelect" class="form-select form-control">
                                    ...
                                    <tr>
                                        ...
                                        <td class="align-middle text-center" colspan="2">
                                            <div class="d-flex px-2 py-1">
                                                ...
                                                <div class="d-flex flex-column justify-content-center">
                                                    <h6 class="mb-0 text-sm">
                                                        <input type="text" class="form-control" name="nomfournisseur"
                                        ...
                                        <td class="align-middle text-center">
                                            <span class="text-secondary text-xs font-weight-bold"> 
                                                <select name="categorie" class="form-select produit-select form-control me-3">
                                    ...
                                    <tr>
                                        ...
                                        <td class="align-middle text-center">
                                            <div class="input-field">
                                                <label class="custum-file-upload custum-produit-upload p-0" for="file">
                                                    <div class="icon ">
                                        ...
                                        <td class="align-middle text-center">
                                            <input type="number" class="form-control form-control-xs col-1" name="qantiteNew">
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a class="bin-button btn_bottom" href="{{ route('bon_de_commandes', $autoentrepreneur->id) }}">
