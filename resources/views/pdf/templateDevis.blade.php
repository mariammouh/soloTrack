            ...
            <tr>
              <td class="w-1/2 align-top">
                <div class="text-sm text-neutral-600">
                  <p class="font-bold">Entreprise vendeuse : 
                    {{$data[0]['auto_nom']}}</p>
              ...
              <td class="w-1/2 align-top text-right">
                <div class="text-sm text-neutral-600">
                  <p class="font-bold"> Client : {{$data[0]['client_nom']}}</p>
                  <p>Contact: {{$data[0]['client_contact']}}</p>
                  <p>E-mail:  {{$data[0]['client_email']}}</p>
                  <p>Adresse: {{$data[0]['client_adresse']}}</p>
              </td>
            </tr>
          </tbody>
        </table>
      ...
      <div class="px-14 py-10 text-sm text-neutral-700">
        <table class="w-full border-collapse border-spacing-0">
          ...
          <tbody>
              ...
              <td class="border-b py-3 pl-2 text-right"><?php echo $produit['produit_prix']; ?> DH</td>
              <td class="border-b py-3 pl-2 text-center"><?php echo $produit['Quantité']; ?></td>
              <td class="border-b py-3 pl-2 text-center"><?php echo $data[0]['tva']; ?>%</td>

              <td class="border-b py-3 pl-2 text-center"><?php echo $produit['produit_prix']*$produit['Quantité']; ?></td>
              <td class="border-b py-3 pl-2 text-center"><?php echo $produit['produit_prix']*$produit['Quantité'] - $produit['produit_prix']*$produit['Quantité']*$data[0]['tva'] ; ?> DH</td>
            </tr>
              @endforeach 
                          ...
                          <tbody> 
                            ...
                            <tr class=" p-3">
                              ...
                              <td class="bg-main p-3 text-right">
                                <div class="whitespace-nowrap font-bold text-white"><?php echo $data[0]['total_prix']; ?> DH</div>
                              </td>
                            </tr>
                          </tbody>
                        </table>
