@php
    ...
    $auto='';
    if ($navSode ==='dash') {
     $dash='active bg-gradient-primary';
    }else if ($navSode==='profile') {
     $profile='active bg-gradient-primary';
    } elseif ($navSode==='auto') {
     $auto='active bg-gradient-primary';
    }
@endphp
<!DOCTYPE html>
<html lang="en">
  ...
  <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3   bg-gradient-dark" id="sidenav-main">
    <div class="sidenav-header">
        ...
        <a class="navbar-brand m-0" href=" {{ route('home') }}" target="_blank">
            <img src="../images/logo1.png" class="navbar-brand-img h-100" alt="main_logo">
            <span class=" font-weight-bold font-weight-bolder text-white"
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
      <ul class="navbar-nav">
         <li class="nav-item">
          <a class="nav-link text-white {{$dash}} " href="{{ route('admin.dashboard') }}">
        ...
        <li class="nav-item">
          <a class="nav-link text-white {{$auto}}" href="{{route('admin.autoentrepreneurs')}}">
            <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
              <i class="material-icons opacity-10">table_view</i>
            </div>
            <span class="nav-link-text ms-1">Autoentrepreneurs</span>
          </a>
        </li>
        <li class="nav-item">
          <a class="nav-link text-white {{$profile}}" href="{{route('admin.profile')}}">
            <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
                    ...
                    <li class="nav-item dropdown pe-2 d-flex align-items-center">
                        ...
                        <ul class="dropdown-menu  dropdown-menu-end  px-2 py-3 me-sm-n4"
                          ...
                          @foreach ($notifications as $notification )
                            ...
                            <li>
                                <a class="dropdown-item border-radius-md" href="{{route('depenses',$autoentrepreneur->id)}}">
    ...
    <div class="card shadow-lg">
      ...
      <div class="card-body pt-sm-3 pt-0">
        ...
        <div class="mt-3">
            ...
            <p class="text-sm">Choisissez entre 3 types de navigation latérale différents.</p>
        </div>
        <div class="d-flex">
